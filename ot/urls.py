...
urlpatterns = [
    ...
    path('lista_OT/', views.lista_OT, name='lista_OT'),  # Nueva ruta para revisar la lista de OT
    path('crear_OT/', views.crear_OT, name='crear_OT'),  # Nueva ruta para crear una OT
